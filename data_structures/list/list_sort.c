...
/*   Updated: 2020/07/19 14:49:59 by unite            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static t_link	*link_merge_sort(t_list *alst, t_link *start, size_t size)
{
	t_link	*middle;
	...
	start = link_merge_sort(alst, start, size / 2);
	middle = link_merge_sort(alst, middle, size - size / 2);
...
int				list_sort(t_list *alst)
{
	...
	if (alst->head == NULL)
		return (0);
	start = link_merge_sort(alst, alst->head, alst->size);
